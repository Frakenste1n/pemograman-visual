...
public class temu6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ListMakan.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Nasi Goreng", "Rendang", "Sate", "Gado-Gado", "Bakso", "Soto Ayam", "Ayam Goreng", "Pecel Lele" };
        ...
        ListMinuman.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Es Teh Manis", "Es Jeruk", "Kopi Tubruk", "Es Cendol", "Wedang Jahe", "Es Campur", "Bandrek", "Bajigur" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        jList4.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Sepak Bola", "Badminton", "Renang", "Lari", "Basket", "Voli", "Tenis Meja", "Yoga" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
